<?php
  require "db.php";
  $queryProduk = $conn->query("SELECT id, nama, harga_jual, foto FROM produk LIMIT 6");
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
      <div class="row">
        <div class="col-xl-8">
          <h1>Belanja Merchandise Stray Kids Secara Online</h1>
          <h2>SKZstore adalah Website Toko Online yang berisi berbagai macam merchandise Stray Kids dengan harga terjangkau</h2>
          <a href="produk.php" class="btn-get-started scrollto">Lihat Produk</a>
        </div>
      </div>
    </div>
  ...
  <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center">
          <div class="col-sm-6 col-md-4">
            <div class="card text-center">
              <a href="produk.php?kategori=fashion">
                <div class="card-body">
                  <img src="assets/img/kategori/clothes-hanger.png" alt="">
                  <h5 class="card-text mt-2">Fashion</h5>
                </div>
              </a>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="card text-center">
              <a href="produk.php?kategori=photo">
                <div class="card-body">
                  <img src="assets/img/kategori/photo.png" alt="">
                  <h5 class="card-text mt-2">Photo</h5>
                </div>
              </a>
            </div>
          </div>
          <div class="col-sm-6 col-md-4">
            <div class="card text-center">
              <a href="produk.php?kategori=daily">
                <div class="card-body">
                  <img src="assets/img/kategori/cup.png" alt="">
                  <h5 class="card-text mt-2">Daily</h5>
                </div>
              </a>
            </div>
          </div>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container-fluid py-5" data-aos="fade-up">
        ...
        <div class="container text-center">
          <div class="row mt-5">
            <?php while ($data = $queryProduk->fetch(PDO::FETCH_ASSOC)) { ?>
            <div class="col-sm-6 col-md-4 mb-3">
              <div class="card shadow-sm bg-white rounded h-100">
                <img src="assets/img/produk/<?= $data['foto'] ?>" class="card-img-top" alt="...">
                <div class="card-body">
                  <h6 class="card-title"><?= $data['nama'] ?></h6>
                  <div class="card-text">
                    <p class="card-title">Rp <?= $data['harga_jual'] ?></p>
                  </div>
                  <a href="details.php?nama=<?= $data['nama'] ?>" class="btn text-light bg-dark">Lihat Detail</a>
                </div>
              </div>
            </div>
            <?php } ?>
          </div>
          <a class="btn btn-outline-danger mt-3" href="produk.php">See More</a>
        </div>
