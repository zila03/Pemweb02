<?php
  ...
  $queryProduk = $conn->query("SELECT * FROM produk WHERE nama = '$nama'");
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                <img src="assets/img/produk/<?= $produk['foto'] ?>" alt="">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3><?= $produk['nama'] ?></h3>
              <ul>
                <li><strong>Harga</strong>: <?= $produk['harga_jual'] ?></li>
            ...
            <a href="produk.php" class="btn p-2 bg-danger text-white">Kembali</a>
            <a href="pemesanan.php?nama=<?= $produk['nama'] ?>" class="btn p-2 bg-dark text-white">Beli Produk</a>
          </div>
