...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <h3 class="logo me-auto text-light m-3">SKZstore<span class="text-danger">.</span></h3>
    </a>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $row['nama'] ?></td>
                        <td>
                            <a class="btn p-2 bg-primary text-white" href="editk.php?id=<?= $row['id'] ?>">EDIT</a>
                            <a div class="btn p-2 bg-black text-white" href="deletek.php?id=<?= $row['id'] ?>"  
